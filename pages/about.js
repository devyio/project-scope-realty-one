  ...
  return (
    <div>
      ...
      <div>
        ...
        <section className="aboutsec_wrap">
          <div className="container">
            <div className="row">
              <div className="col-lg-5  col-md-6">
                <div className="pageheading_wrap">
                  <h2>
                    About{" "}
                    <strong>
                      <span>Us</span>
              ...
              <div className="col-lg-7 col-md-6">
                <div className="aboutimage_wrap">
                  <img src="assets/img/about/Frame.png" alt="aboutimage" />
                </div>
              </div>
            </div>
          </div>
        </section>
        {/* company value sec start */}
        <section className="comvalue_sec">
          <div className="container">
            <div className="comvaluecontent_wrap">
              <div className="pagesubtitle_wrap">
                <h2>Company value</h2>
              ...
              <div className="valueslist_wrap">
                <ul className="valueslist">
                  <li>
                    <img
                      src="assets/img/about/featureicon.png"
                      alt="featureicon"
                    />
                    <p>Value 1</p>
                  </li>
            ...
            <div className="teamsec_wrap">
              ...
              <div className="valueslist_wrap">
                <ul className="valueslist tamlist">
                  <li>
                    <img src="assets/img/about/jhon.png" alt="featureicon" />
                    <p>John Doe</p>
                  </li>
                  <li>
                    <img src="assets/img/about/jennoce.png" alt="featureicon" />
                    <p>Jennice A</p>
                  </li>
                  <li>
                    <img src="assets/img/about/michale.png" alt="featureicon" />
                    <p>Michale R</p>
                  </li>
                  <li>
                    <img src="assets/img/about/larkson.png" alt="featureicon" />
                    <p>Larkson</p>
                  </li>
                  <li>
                    <img
                      src="assets/img/about/michelle.png"
                      alt="featureicon"
                    />
                    <p>Michelle</p>
                  </li>
                  <li>
                    <img src="assets/img/about/maria.png" alt="featureicon" />
                    <p>Maria M</p>
                  </li>
                </ul>
              </div>
        ...
        <section className="practicesec">
          <div className="container">
            <div className="row">
              <div className="col-lg-6 practicecon_wrap">
